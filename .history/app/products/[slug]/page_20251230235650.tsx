  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-slate-950 to-black py-12 px-4">
      <div className="max-w-7xl mx-auto animate-fadeIn">
        ...
        {/* Product Card */}
        <div className="bg-slate-900/80 backdrop-blur-xl rounded-3xl overflow-hidden shadow-2xl border border-slate-800/50 flex flex-col lg:flex-row animate-slideUp">
          {/* Cột Ảnh */}
          <div className="lg:w-1/2 relative h-[450px] lg:h-auto overflow-hidden bg-gradient-to-br from-slate-900 to-black flex items-center justify-center">
            ...
            {/* Badge SALE */}
            {product.isSale && (
              <div className="absolute top-6 left-6 bg-gradient-to-r from-red-600 to-orange-600 text-white px-6 py-2 rounded-full font-black text-sm uppercase shadow-2xl shadow-red-900/60 animate-pulse border-2 border-red-400/50">
          ...
          <div className="lg:w-1/2 p-8 lg:p-14 flex flex-col justify-between">
            <div>
              <h1 className="text-4xl lg:text-5xl font-black text-white mb-6 leading-tight uppercase tracking-tight animate-fadeIn">
                {product.name}
              </h1>
              ...
              <div className="mb-8">
                {product.isSale ? (
                  <div className="flex items-baseline gap-6">
                    <span className="text-5xl lg:text-6xl font-black bg-gradient-to-r from-emerald-400 to-green-400 bg-clip-text text-transparent animate-pulse">
              ...
              {/* Add to Cart */}
              <div className="mb-10 animate-bounceSlow">
                <AddToCartBtn
                  product={product}
              ...
              {product.isSale && product.promoEnd && (
                <div className="bg-gradient-to-r from-red-900/30 to-orange-900/30 border border-red-800/50 rounded-2xl p-6 flex items-center justify-between backdrop-blur-sm mb-10 animate-fadeIn delay-300">
                  <div>
            ...
            {/* Cam kết dịch vụ */}
            <div className="pt-8 border-t border-slate-800 grid grid-cols-2 gap-5 text-sm font-bold text-gray-400 uppercase tracking-wider animate-fadeIn delay-500">
