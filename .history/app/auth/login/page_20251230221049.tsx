...
{/* Register link */} <p className="text-center text-gray-300 text-sm mt-8"> Chưa có tài khoản?{' '} <Link href="/auth/register" className="text-emerald-400 hover:text-emerald-300 font-bold underline"> Đăng ký ngay </Link> </p> </div> </div> ); }