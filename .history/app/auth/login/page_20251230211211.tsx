...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex justify-center items-center min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-950 px-4 overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1600585154340-be6161a56a0c?ixlib=rb-4.0.3&auto=format&fit=crop&q=80')] bg-cover bg-center opacity-20" />
      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-black/60" />

      {/* Card */}
      <div className="relative w-full max-w-md bg-white/10 backdrop-blur-2xl shadow-2xl rounded-3xl p-8 border border-white/20 overflow-hidden">
        {/* Glow */}
        <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-emerald-500/20 to-cyan-500/20 blur-2xl -z-10" />
        ...
        {/* Tabs */}
        <div className="flex mb-8 bg-black/40 rounded-xl p-1 border border-white/20">
          <button
        ...
        {/* Warning */}
        {selectedRole === 'admin' && (
          <div className="mb-6 p-4 bg-yellow-900/40 border border-yellow-600/50 text-yellow-200 rounded-xl text-sm flex items-center gap-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-gray-400 focus:ring-4 focus:ring-emerald-500/50 focus:border-emerald-400 focus:outline-none transition"
          ...
          <button
            ...
            hover:from-emerald-600 hover:to-teal-700 text-white font-bold py-4 rounded-xl 
            transition-all transform hover:scale-105 hover:shadow-2xl hover:shadow-emerald-500/50 
