...
const CATEGORIES = [
  { id: 1, title: "Áo quần bóng đá", sub: "Trendy", img: "/categories/ao.jpg" },
  { id: 2, title: "Giày", sub: "Unique", img: "/categories/giay.jpg" },
  { id: 3, title: "Bóng", sub: "Special", img: "/categories/bong.jpg" },
    ...
    {products.find(p => p.isSale && p.promoEnd) && (
      ...
      <div className="max-w-6xl mx-auto px-4 -mt-8 relative z-20 flex flex-col md:flex-row gap-4">
          ...
          >
            ...
            <option value="1">👕 Áo quần bóng đá</option>
