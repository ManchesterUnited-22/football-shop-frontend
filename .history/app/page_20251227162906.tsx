        ...
        <div className="col-span-1 md:col-span-1">
          <div className="flex items-center gap-2 mb-6">
            <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center">
              <span className="text-blue-600 font-black text-xl">4F</span>
            </div>
            <span className="text-white font-black text-xl tracking-tighter italic">FOOTBALL STORE</span>
          </div>
          <p className="text-sm leading-relaxed opacity-70">
            Chuyên cung cấp trang phục và phụ kiện thể thao chính hãng. Đồng hành cùng niềm đam mê sân cỏ của bạn.
          </p>
        </div>

        {/* CỘT 2: DANH MỤC */}
        <div>
          <h3 className="text-white font-bold mb-6 uppercase text-sm tracking-widest">Danh mục</h3>
          <ul className="space-y-4 text-sm">
            <li><a href="#" className="hover:text-blue-400 transition-colors">Áo thi đấu</a></li>
            <li><a href="#" className="hover:text-blue-400 transition-colors">Giày bóng đá</a></li>
            <li><a href="#" className="hover:text-blue-400 transition-colors">Phụ kiện thể thao</a></li>
            <li><a href="#" className="hover:text-blue-400 transition-colors">Hàng mới về</a></li>
          </ul>
        </div>

        {/* CỘT 3: CHÍNH SÁCH */}
        <div>
          <h3 className="text-white font-bold mb-6 uppercase text-sm tracking-widest">Hỗ trợ khách hàng</h3>
          <ul className="space-y-4 text-sm">
            ...
            <li><a href="#" className="hover:text-blue-400 transition-colors">Hướng dẫn chọn size</a></li>
            <li><a href="#" className="hover:text-blue-400 transition-colors">Vận chuyển & Giao hàng</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            <li className="flex items-center gap-3">
              ...
              <span>123 Đường Cầu Lông, Quận 1, TP. HCM</span>
            </li>
            <li className="flex items-center gap-3">
              <span className="text-lg">📞</span>
              <span className="font-bold text-white">090 123 4567</span>
            </li>
            <li className="flex items-center gap-3">
              <span className="text-lg">✉️</span>
              <span>contact@4football.com</span>
            </li>
          </ul>
          {/* MXH */}
          <div className="flex gap-4 mt-6">
            <div className="w-8 h-8 bg-white/10 rounded-full flex items-center justify-center hover:bg-blue-600 transition-all cursor-pointer">f</div>
            <div className="w-8 h-8 bg-white/10 rounded-full flex items-center justify-center hover:bg-pink-600 transition-all cursor-pointer">ig</div>
            <div className="w-8 h-8 bg-white/10 rounded-full flex items-center justify-center hover:bg-blue-400 transition-all cursor-pointer">z</div>
          </div>
        </div>
      </div>

      {/* DÒNG BẢN QUYỀN */}
      <div className="max-w-6xl mx-auto px-4 mt-16 pt-8 border-t border-white/5 text-center text-xs opacity-40 uppercase tracking-[0.2em]">
        © 2025 4FOOTBALL STORE. All Rights Reserved. Designed by Lập.
      </div>
    </footer>
  );
};
