      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-b-3xl shadow-sm p-8 space-y-8">
          ...
          <div className="pt-6 border-t flex justify-end gap-4">
            <button className="flex items-center gap-2 px-6 py-2.5 bg-indigo-600 text-white font-bold rounded-xl hover:bg-indigo-700 transition-all shadow-md active:scale-95">
