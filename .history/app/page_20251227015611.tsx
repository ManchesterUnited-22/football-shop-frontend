...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-slate-900">
      ...
      {/* --- HERO SECTION --- */}
      <section className="h-[400px] w-full relative flex items-center justify-center text-white overflow-hidden">
        <video autoPlay loop muted playsInline className="absolute inset-0 w-full h-full object-cover">
          <source src="/FOOTBALL.mp4" type="video/mp4" />
        </video>
        <div className="absolute inset-0 bg-black/60"></div>
        <h1 className="relative z-10 text-5xl font-black italic uppercase tracking-tighter">4FOOTBALL STORE</h1>
      </section>
