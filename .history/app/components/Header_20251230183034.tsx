        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center gap-10 flex-1 justify-center">
              ...
              <Link href="/products" className="font-bold text-lg hover:text-red-400 transition-all hover:scale-110">
                Sản Phẩm
              </Link>
              <Link href="/promotions" className="font-bold text-lg hover:text-red-400 transition-all hover:scale-110">
                Khuyến Mãi
              </Link>
              <Link href="/blog" className="font-bold text-lg hover:text-red-400 transition-all hover:scale-110">
                Tin Tức Bóng Đá
              </Link>
              {isLoggedIn && (
            ...
            {/* Right Section: Search (nếu muốn thêm sau), User & Cart */}
          ...
          {isMobileMenuOpen && (
            <nav className="lg:hidden mt-6 pb-4 border-t border-white/20 pt-6">
              <div className="flex flex-col gap-4">
                ...
                <Link href="/products" className="font-bold text-lg hover:text-red-400 transition">Sản Phẩm</Link>
                <Link href="/promotions" className="font-bold text-lg hover:text-red-400 transition">Khuyến Mãi</Link>
                <Link href="/blog" className="font-bold text-lg hover:text-red-400 transition">Tin Tức</Link>
                {isLoggedIn && <Link href="/user/orders" className="font-bold text-lg hover:text-red-400 transition">Đơn Hàng</Link>}
                {!isLoggedIn && (
                  <>
