      ...
      <button
        ...
        className={`w-full py-5 rounded-xl font-black text-xl uppercase tracking-wider flex items-center justify-center gap-4 transition-all duration-300 shadow-xl
          ${isBuyDisabled
            ...
            : 'bg-gradient-to-r from-emerald-600 to-green-700 hover:from-emerald-700 hover:to-green-800 text-white shadow-emerald-600/50 hover:shadow-emerald-600/80 hover:-translate-y-1 active:scale-95'
          }
        `}
      >
