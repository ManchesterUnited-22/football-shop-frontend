          ...
          {isMobileMenuOpen && (
            <nav className="lg:hidden mt-6 pb-4 border-t border-white/20 pt-6">
              <div className="flex flex-col gap-4">
                ...
                {isRegularUser && ( <Link href="/user" className="hidden sm:block bg-gradient-to-r from-green-400 to-blue-500 text-black font-extrabold px-6 py-2.5 rounded-full shadow-lg hover:scale-105 transition-all animate-pulse hover:animate-none" > USER PANEL </Link> )}
              </div>
            </nav>
          )}
        </div>
