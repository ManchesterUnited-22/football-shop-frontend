      ...
      <header className="bg-gradient-to-b from-green-900 via-black to-green-900 text-white shadow-2xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            {/* Right Section: Panel Button + User + Cart */}
            <div className="flex items-center gap-4">

              {/* Nút nổi bật cho User hoặc Admin */}
              {isAdmin && (
              ...
              {isRegularUser && (
                <Link href="/profile" className="hidden sm:block bg-gradient-to-r from-yellow-400 to-orange-500 text-black font-extrabold px-6 py-2.5 rounded-full shadow-lg hover:scale-105 transition-all animate-pulse hover:animate-none">
                  TRANG CÁ NHÂN
                </Link>
              )}
          ...
          {isMobileMenuOpen && (
            <nav className="lg:hidden mt-6 pb-4 border-t border-white/20 pt-6">
              <div className="flex flex-col gap-4">
                ...
                {isRegularUser && <Link href="/profile" className="font-bold text-lg hover:text-red-400 transition">Trang Cá Nhân</Link>}
