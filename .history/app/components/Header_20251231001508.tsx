        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              ...
              {/* User Panel Button */}
              {isRegularUser && (
                <Link href="/user" className="hidden sm:block bg-gradient-to-r from-green-400 to-blue-500 text-black font-extrabold px-6 py-2.5 rounded-full shadow-lg hover:scale-105 transition-all animate-pulse hover:animate-none">
                  USER PANEL
                </Link>
              )}
