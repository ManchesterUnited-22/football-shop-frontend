...
function CartButton({
  ...
  const disabled = !currentVariant || currentVariant.stock <= 0;
...
export default function AddToCartBtn({
  ...
  return (
    <div className="mt-6">
      ...
      <CartButton currentVariant={currentVariant} onAdd={handleAddToCart} />
    </div>
  );
}
