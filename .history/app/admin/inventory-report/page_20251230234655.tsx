...
import { Package, TrendingUp, Filter, AlertTriangle, Plus } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 p-6 bg-red-50 rounded-2xl">
              <div>
                ...
                <div className="flex gap-3">
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-4 focus:ring-red-500/30"
                  />
                  <button
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-4 focus:ring-emerald-500/30 bg-white"
                >
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-4 focus:ring-emerald-500/30"
                  />
                  <button
