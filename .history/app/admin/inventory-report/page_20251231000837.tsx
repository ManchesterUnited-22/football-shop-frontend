...
const InventoryReportPage = () => {
  ...
  // Đồng bộ input với state khi giá trị thay đổi từ server hoặc filter khác
  useEffect(() => {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
          ...
          <section className="bg-white rounded-3xl shadow-xl border border-red-200 p-8">
            ...
            {/* Filters - Đã cải thiện giao diện */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 p-6 bg-red-50 rounded-2xl">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  />
                  <button
                    onClick={() => setThreshold(Math.max(1, parseInt(inputThreshold) || 10))}
                    disabled={parseInt(inputThreshold || '10') === threshold}
                    className={`px-5 py-3 rounded-xl font-bold transition whitespace-nowrap ${
                      parseInt(inputThreshold || '10') === threshold
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  />
                  <button
                    onClick={() => setLimit(Math.max(1, Math.min(100, parseInt(inputLimit) || 20)))}
                    disabled={parseInt(inputLimit || '20') === limit}
                    className={`px-5 py-3 rounded-xl font-bold transition whitespace-nowrap ${
                      parseInt(inputLimit || '20') === limit
                        ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                        : 'bg-red-600 hover:bg-red-700 text-white shadow-md'
                    }`}
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 p-6 bg-emerald-50 rounded-2xl border border-emerald-200">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  />
                  <button
                    onClick={() => setSalesLimit(Math.max(1, Math.min(50, parseInt(inputSalesLimit) || 10)))}
                    disabled={parseInt(inputSalesLimit || '10') === salesLimit}
                    className={`px-5 py-3 rounded-xl font-bold transition whitespace-nowrap ${
                      parseInt(inputSalesLimit || '10') === salesLimit
                        ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
