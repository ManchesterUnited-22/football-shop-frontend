...
const InventoryReportPage = () => {
  ...
  const handleOpenModal = (item: LowStockItem) => {
    ...
    setNewStockValue(item.stock + 20); // Gợi ý nhập thêm 20
    setIsModalOpen(true);
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
          ...
          <section className="bg-white rounded-3xl shadow-xl border border-red-200 p-8">
            ...
            {/* Filters - ĐÃ CHỈNH KÍCH THƯỚC INPUT VỪA PHẢI */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 p-6 bg-red-50 rounded-2xl">
              <div>
                ...
                <div className="flex gap-3">
                  <input
                    ...
                    className="w-full px-5 py-4 rounded-xl border border-gray-300 focus:ring-4 focus:ring-red-500/30 text-lg font-medium text-center"
                  />
                  <button
                    onClick={() => setThreshold(parseInt(inputThreshold) || 10)}
                    className="px-6 py-4 bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl transition whitespace-nowrap"
                  >
                    Áp dụng
                  </button>
                </div>
              ...
              <div>
                ...
                <div className="flex gap-3">
                  ...
                  />
                  <button
                    onClick={() => setLimit(parseInt(inputLimit) || 20)}
                    className="px-6 py-4 bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl transition whitespace-nowrap"
                  >
                    Áp dụng
                  </button>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-5 py-4 rounded-xl border border-gray-300 focus:ring-4 focus:ring-emerald-500/30 bg-white text-lg"
                >
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <input
                    ...
                    className="w-full px-5 py-4 rounded-xl border border-gray-300 focus:ring-4 focus:ring-emerald-500/30 text-lg font-medium text-center"
                  />
                  <button
                    onClick={() => setSalesLimit(parseInt(inputSalesLimit) || 10)}
                    className="px-6 py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl transition whitespace-nowrap"
                  >
                    Áp dụng
                  </button>
                </div>
        ...
        {/* Modal Nhập Hàng - Input số lượng ĐẸP & TO HỢP LÝ */}
        {isModalOpen && selectedItem && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 animate-in fade-in duration-300">
            <div className="bg-white rounded-3xl shadow-2xl p-10 max-w-md w-full mx-4 animate-in zoom-in-95 duration-300">
              ...
              <label className="block text-xl font-bold text-gray-700 mb-4">Số lượng sau khi nhập</label>
              <input
                type="number"
                value={newStockValue}
                onChange={(e) => setNewStockValue(parseInt(e.target.value) || 0)}
                min={selectedItem.stock + 1}
                className="w-full px-8 py-6 text-4xl font-black text-center rounded-2xl border-4 border-emerald-300 focus:border-emerald-600 focus:ring-8 focus:ring-emerald-500/30 mb-10 bg-emerald-50"
              />

              <div className="flex gap-4">
                <button
                  onClick={handleCloseModal}
                  className="flex-1 py-5 bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold text-xl rounded-2xl transition"
                >
                  Hủy
                </button>
                <button
                  ...
                  className="flex-1 py-5 bg-gradient-to-r from-emerald-600 to-green-700 hover:from-emerald-700 hover:to-green-800 text-white font-black text-xl rounded-2xl transition shadow-xl disabled:opacity-60"
                >
                  Xác nhận nhập hàng
                </button>
              </div>
