        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg w-full md:w-96 order-2 sticky top-4 h-fit">
            {editingProduct ? (
              ...
              className="block text-center py-4 bg-yellow-500 hover:bg-yellow-600 text-black font-bold rounded-xl shadow transition-all flex items-center justify-center gap-3 text-lg"
