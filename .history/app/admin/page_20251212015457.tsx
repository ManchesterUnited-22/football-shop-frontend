                    ...
                    <div className="bg-white p-6 rounded-xl shadow-lg sticky top-4 h-fit w-full md:w-1/2 order-2">
                        ...
                        {editingProduct ? (
                            ...
                            <div className='flex flex-col space-y-4'>
                                ...
                                <Link href="/admin/inventory-report" passHref >
                                <button className='flex items-center justify-center h-10 className="bg-indigo-100 text-indigo-700 py-2 px-4 rounded hover:bg-indigo-200" text-indigo-700 font-semibold py-2 px-4 rounded-lg transition shadow-sm'>
                                    Xem Báo cáo Kho
                                </button>
                                </Link>
