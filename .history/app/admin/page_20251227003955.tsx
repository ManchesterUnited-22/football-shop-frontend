          ...
          <div className="bg-white p-6 rounded-xl shadow-lg w-full md:w-96 order-2 sticky top-4 h-fit">
            {editingProduct ? (
              ...
              <div className="space-y-5">
                ...
                <div className="p-5 bg-gray-50 rounded-xl text-center border-t-4 border-orange-500">
                  <p className="text-gray-600 text-sm">Hỗ trợ kỹ thuật</p>
                  <p className="font-bold text-lg mt-1">Hotline: 1900 xxxx</p>
                </div>
              </div>
            )}
          </div>
