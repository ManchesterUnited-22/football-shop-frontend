...
const BankTransferInfo = ({ orderId, amount }: { orderId: number; amount: number }) => (
  <div className="bg-yellow-100 border-2 border-yellow-500 text-yellow-800 p-5 rounded-xl mt-6">
    ...
    <div className="space-y-3 p-3 bg-white rounded-lg border">
      ...
      <p>
        <strong>Số Tài khoản:</strong> 0071000888888
      </p>
      <p>
        <strong>Chủ Tài khoản:</strong> 4FOOTBALL SHOP
      </p>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-6">
      <div className="max-w-2xl w-full bg-white p-10 rounded-2xl shadow-xl">
        ...
        {isBankTransfer ? (
          ...
          <div className="bg-green-50 border border-green-300 p-5 rounded-lg text-center">
