...
type OrderDetail = {
    ...
    note: string; // Đây là trường chúng ta vừa thêm, chứa thông tin thanh toán
};

// Hàm giả định để format tiền tệ (Lấy từ Checkout Page)
...
    const params = useParams();
    const orderId = Number(params.id); // Ép kiểu thành số
    ...
    // Logic đơn giản: Nếu 'note' chứa 'CHUYỂN KHOẢN NGÂN HÀNG' thì là chuyển khoản.
