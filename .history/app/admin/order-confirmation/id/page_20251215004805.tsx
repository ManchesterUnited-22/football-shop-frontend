...
// import Image from 'next/image'; // ⬅️ ĐÃ BỎ IMPORT IMAGE
...
// =========================================================
// Component con: Hiển thị hướng dẫn chuyển khoản (KHÔNG CÓ QR)
// =========================================================
const BankTransferInfo = ({ orderId, amount }: { orderId: number, amount: number }) => (
    <div className="bg-yellow-100 border-2 border-yellow-500 text-yellow-800 p-5 rounded-xl mt-6">
        ...
        <div className="space-y-3 p-3 bg-white rounded-lg border">
            ...
            <p><strong>Chủ Tài khoản:</strong> 4FOOTBALL s</p>
...
export default function OrderConfirmationPage() {
    ...
    // 2. Gọi API để lấy chi tiết đơn hàng
    useEffect(() => {
    ...
    // 3. Kiểm tra xem đây có phải đơn hàng Chuyển khoản không
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
            <div className="max-w-xl w-full bg-white p-8 rounded-xl shadow-2xl text-center">
                ...
                {/* 4. HIỂN THỊ THÔNG TIN CHUYỂN KHOẢN (VĂN BẢN) */}
                {isBankTransfer && (
