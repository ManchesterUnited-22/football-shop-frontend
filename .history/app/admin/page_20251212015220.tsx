...
export default function AdminPage() {
  ...
  <button className='flex items-center justify-center h-12 bg-indigo-100 hover:bg-indigo-200 text-indigo-700 font-semibold py-3 px-6 rounded-lg transition shadow-sm'>
    <ReportIcon size={20} className="mr-2" />
    Xem Báo cáo Kho
  </button>
</Link>
