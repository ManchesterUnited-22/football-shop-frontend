            ...
            {editingProduct ? (
              ...
              <div className="space-y-5">
                ...
                <Link
                 ...
                 className="block text-center py-4 **bg-red-600 hover:bg-red-700 text-white** font-bold rounded-xl shadow transition-all flex items-center justify-center gap-3 text-lg"
                >
