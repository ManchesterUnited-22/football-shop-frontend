                    ...
                    <div className="bg-white p-6 rounded-xl shadow-lg sticky top-4 h-fit w-full md:w-1/2 order-2">
                        ...
                        {editingProduct ? (
                            ...
                            <div className='flex flex-col space-y-4'>
                                ...
                                <Link
                                    href="/admin/orders" // Địa chỉ mới: Trang quản lý Đơn hàng
                                    className="w-full"
                                >
                                    <button
                                        className="flex items-center justify-center h-12 bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-lg transition shadow-md w-full"
                                    >
                                        <Truck size={20} className="mr-2"/> XỬ LÝ ĐƠN HÀNG MỚI
                                    </button>
                                </Link>
                                <Link 
                                    href="/admin/inventory-report" 
                                    passHref // Prop này giúp thẻ Link truyền href xuống thẻ con
                                    className="w-full" // 🚨 THÊM CLASS w-full VÀO LINK (để Link chiếm toàn bộ chiều rộng)
                                >
                                    <button 
                                        className='flex items-center justify-center h-12 bg-indigo-100 hover:bg-indigo-200 text-indigo-700 font-semibold py-3 px-6 rounded-lg transition shadow-sm w-full'
                                        // 🚨 THÊM CLASS w-full VÀO BUTTON (để button giãn ra hết thẻ Link)
                                    >
                                        Xem Báo cáo Kho
                                    </button>
                                </Link>
