          ...
          <div className="bg-white p-6 rounded-xl shadow-lg w-full md:w-96 order-2 sticky top-4 h-fit">
            {editingProduct ? (
              ...
              <div className="space-y-5">
                ...
                className="block text-center py-4 bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-xl shadow transition-all flex items-center justify-center gap-3 text-lg"
