...
const MOCK_CATEGORIES: Category[] = [
    { id: 1, name: "Áo Câu Lạc Bộ" },       // Trước đây là Áo đấu chung chung
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 border rounded-lg bg-gray-50">
                    ...
                    <div>
                         ...
                         <input type="number" id="price" value={price} onChange={(e) => setPrice(e.target.value)} required min="0" className="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 p-2" />
                    </div>
